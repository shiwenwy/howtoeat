...
export const getMeun = async(files, peopleNum, weight, meat, vegetable, consumeSliderValue, diet, setFinalResult) => {
  ...
  console.log('useMeun');
    const json = {
      ...
      const headers = {
        'Authorization': 'Bearer ' + eatBizConfig.cozeToken
      }
      const data = {
        'bot_id': eatBizConfig.cozeBotId,
